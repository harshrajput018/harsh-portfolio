...
export const PROJECTS = [
  ...
  {
    id: "03", name: "KnowledgeHub AI", tagline: "A retrieval-augmented generation platform",
  ...
  {
    id: "05", name: "PyQueue", tagline: "A distributed task queue, built to prove out the mechanics",
